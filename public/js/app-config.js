export const APP_CONFIG = {
  brandName: 'NightLoot Digital',
  tagline: 'ร้านสินค้า digital สไตล์เว็บขายไอดีเกม ที่ใช้ Firebase เป็น backend ทั้งชุด',
  ...
  paymentMethods: [
    ...
    },
    {
      ...
      accountValue: '080-000-0000',
      description: 'รองรับลูกค้าที่ชำระผ่านวอลเลตและแนบสลิปได้ทันที'
    }
  ],
  supportChannels: [
    'LINE: @nightloot',
